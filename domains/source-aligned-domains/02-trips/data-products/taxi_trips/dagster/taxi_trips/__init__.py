...
trip_assets = load_assets_from_modules(modules=[trips])
metric_assets = load_assets_from_modules(modules=[metrics])
request_assets = load_assets_from_modules(modules=[requests])
